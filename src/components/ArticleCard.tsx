...
export function ArticleCard({ article, onTagClick, showCategoryBadge = true, activeTag }: ArticleCardProps) {
  ...
  return (
    <div
      ...
      className={`group bg-white rounded-xl border border-gray-200 border-l-4 border-l-blue-500 p-5 cursor-pointer transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg flex flex-col gap-3 h-full`}
    >
      {showCategoryBadge && (
